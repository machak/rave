                ...
                <c:if test="${currentUsername == userProfile.username}">
                    <fieldset>
                        <p>
                            ...
                            <button type="submit" class="btn btn-primary profile-info-hidden" value="${save}">${save}</button>
                            <button type="button" class="btn btn-warning profile-info-hidden" id="cancelEdit"><fmt:message key="page.profile.cancel"/></button>
                        </p>
                    </fieldset>
                </c:if>
            </form:form>
