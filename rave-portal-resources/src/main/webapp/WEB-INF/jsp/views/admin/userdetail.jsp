    ...
    <div class="span6">
      <c:if test="${canChangeUserStatus}">
        <section>
          ...
          <form:form cssClass="form-horizontal well" id="deleteUserProfile" action="delete" commandName="user" method="POST">
            <fieldset>
            ...
            <fieldset>
              <p>
                <button type="submit" class="btn btn-danger" value="Delete the user">Delete the user</button>
              </p>
            </fieldset>
          </form:form>
        </section>
