        ...
        <div class="container">
            ...
            <div class="modal-header"><h1><fmt:message key="${pageTitleKey}"/></h1></div>
                <%--
                    ...
                    //############################################
                --%>
            <form class="form-horizontal well" id="loginForm" name="loginForm" action="j_spring_security_check" method="post">
            ...
            <form class="form-horizontal well" name='oidf' action='j_spring_openid_security_check' method='POST'>
